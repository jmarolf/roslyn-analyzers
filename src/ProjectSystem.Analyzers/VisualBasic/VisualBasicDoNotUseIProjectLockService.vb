...
Namespace ProjectSystem.VisualBasic.Analyzers
    ...
    Public Class VisualBasicDoNotUseIProjectLockService
        Inherits AbstracDoNotUseIProjectLockService(Of SyntaxKind, VisualBasicErrorAllUseagesOfType, MemberAccessExpressionSyntax, InvocationExpressionSyntax)
