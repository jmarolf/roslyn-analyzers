...
Namespace ProjectSystem.VisualBasic.Analyzers
    ...
    Public Class VisualBasicDoNotUseIProjectGuidService
        Inherits AbstractDoNotUseIProjectGuidService(Of SyntaxKind, VisualBasicErrorAllUseagesOfType, MemberAccessExpressionSyntax, InvocationExpressionSyntax)
