...
namespace ProjectSystem.CSharp.Analyzers
{
    ...
    public class CSharpDoNotUseIProjectLockService
        : AbstracDoNotUseIProjectLockService<SyntaxKind, CSharpErrorAllUseagesOfType, MemberAccessExpressionSyntax, InvocationExpressionSyntax>
    {
