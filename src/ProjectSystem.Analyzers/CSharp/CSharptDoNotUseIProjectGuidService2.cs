...
namespace ProjectSystem.CSharp.Analyzers
{
    ...
    public class CSharptDoNotUseIProjectGuidService2
        : AbstractDoNotUseIProjectGuidService2<SyntaxKind, CSharpErrorAllUseagesOfType, MemberAccessExpressionSyntax, InvocationExpressionSyntax>
    {
